union () {
  color ([0.3, 0.3, 0.6, 1]) {
    translate ([500, 125, -5]) {
      cube ([1000, 250, 1], center=true);
    }
  }
  translate ([285, 145, 0]) {
    union () {
      translate ([275.0, 140, 0]) {
        mirror ([1, 0, 0]) {
          difference () {
            color ([0.98, 0.92, 0.6, 1]) {
              union () {
                hull () {
                  ...
                  rotate (a=14.0, v=[0, 0, 1]) {
                    translate ([0.0, 0.0, 0]) {
                      translate ([8.5, -26.979999999999997, 0]) {
                        cube ([24, 24, 1.5], center=true);
                      }
                    }
                  }
                ...
                union () {
                  difference () {
                    ...
                    hull () {
                      union () {
                        rotate (a=14.0, v=[0, 0, 1]) {
                          translate ([-17.29, -6.6499999999999995, 0]) {
                            translate ([27.5, 0, 0]) {
                              cube ([7.98, 13.98, 25], center=true);
                            }
                          }
                        }
                        rotate (a=14.0, v=[0, 0, 1]) {
                          translate ([-17.29, 34.2, 0]) {
                            translate ([27.5, 0, 0]) {
                              cube ([7.98, 13.98, 25], center=true);
                            }
                          }
